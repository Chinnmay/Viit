...
;I have already created 'ABC.txt' file and written some text in it.
...
section .data
	file_name db 'ABC.txt',0		;'ABC.txt' is already created and contents are already present in it
